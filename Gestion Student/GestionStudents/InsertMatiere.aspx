<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InsertMatiere.aspx.vb" Inherits="GestionStudents.InsertMatiere" MasterPageFile="~/Site.Master" %>

<asp:Content ID="Content1" runat="server" 
    contentplaceholderid="ContentPlaceHolder1">
    <div class="content_box" style="position:absolute; top: 342px; left: 515px;" runat="server">
