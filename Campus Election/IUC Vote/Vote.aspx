<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Vote.aspx.vb" Inherits="IUC_Vote.WebForm2" 
    title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <h2>
       <br /><br />
       <h1><center>Candidature</center></h1><br /><br />
         <asp:GridView 
         
         ID="GridView1" runat="server" 
               AutoGenerateColumns="False" Width="684px"
    Height="16px" CellPadding="4" BorderColor="Blue" ForeColor="#333333" GridLines="None" 
